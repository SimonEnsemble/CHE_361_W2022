...
![](https://raw.githubusercontent.com/SimonEnsemble/CHE_361_W2022/main/studios/GPU_cooling_fan.png)
...
md"👽 suppose the steady-state heat generation $\bar{q}$ and steady-state air temperature $\bar{\theta_a}$ are as defined below. calcluate the steady-state value of the GPU temperature, $\bar{\theta}$ [°C]."

# ╔═╡ 3dd2ac71-7ff8-4e14-94d0-4a2ddd6ae665
begin
	# steady-state heat output
	q̄  = 100.0     # J / s
	# steady-state air temperature
	θ̄ₐ = 25.0      # °C
end

# ╔═╡ 25461da4-d9ef-46df-be2d-e61ced50cbc8
...
# ╔═╡ 6a17cb95-5ae3-4d7f-b65e-eb785ecc3c4b
...
manifest_format = "2.0"
project_hash = "83892f96a6da9d492c902d254bd8812171dc5454"
...
git-tree-sha1 = "17e64510fa886862ca0fd2d94b4d5f859f834995"
